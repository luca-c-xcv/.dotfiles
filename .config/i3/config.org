...
set $hubC "DP-1-1"
 ...
 workspace 1 output $dockC $hubL $external $internal 
 workspace 3 output $dockC $hubL $external $internal
 workspace 5 output $dockC $hubL $external $internal
 workspace 7 output $dockC $hubL $external $internal
 workspace 9 output $dockC $hubL $external $internal
 workspace 11 output $external $internal 
 workspace 13 output $external $internal
 workspace 15 output $external $internal
 workspace 17 output $external $internal
 workspace 19 output $external $internal 

 workspace 2 output $dockR $hubC$internal
 workspace 4 output $dockR $hubC$internal
 workspace 6 output $dockR $hubC$internal
 workspace 8 output $dockR $hubC$internal
 workspace 10 output $dockR $hubC $internal
 workspace 12 output $internal
 workspace 14 output $internal
 workspace 16 output $internal
 workspace 18 output $internal
 workspace 20 output $internal
...
# bindsym $super+b exec brave-browser 127.0.0.1

## Launch // Browser selector // <><Shift>b ##
...
bindsym $super+F1 workspace number $ws11
bindsym $super+F2 workspace number $ws12
bindsym $super+F3 workspace number $ws13
bindsym $super+F4 workspace number $ws14
bindsym $super+F5 workspace number $ws15
bindsym $super+F6 workspace number $ws16
bindsym $super+F7 workspace number $ws17
bindsym $super+F8 workspace number $ws18
bindsym $super+F9 workspace number $ws19
...
# for_window [class=Brave] border pixel 1
...
client.focused					$lightest			$mediumdarkgrey			$yellowbrown				$lightblue			$lightest
...
bar 
{
		...
		colors 
		{
			...
			focused_workspace					$lightest	   			 	$lightest				$colorbar				$purple
			active_workspace					$darkest					$darkest				$white					$purple
			inactive_workspace					$colorbar					$darkest				$colorbar				$purple
